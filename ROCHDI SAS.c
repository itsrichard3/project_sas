...
void ajoute_une_tache()
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        } while (liste_des_taches[nombre_tache].Date.d < 1 || liste_des_taches[nombre_tache].Date.d > 31 || liste_des_taches[nombre_tache].Date.m < 1 || liste_des_taches[nombre_tache].Date.m > 12 || liste_des_taches[nombre_tache].Date.y > 2023);

        do
        {
            printf("1 pour pour_faire, 2 en_train_a_faire, 3 finalise\n ");
            scanf(" %d", &statu);
            ...
            default:
                ...
                continue; // Prompt for status again if an invalid option is chosen.
            }
