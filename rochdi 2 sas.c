...
void ajoute_une_tache()
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        } while ( liste_des_taches[i].Date.d < 1 || liste_des_taches[i].Date.d > 31 || liste_des_taches[i].Date.m < 1 || liste_des_taches[i].Date.m > 12 || liste_des_taches[i].Date.y > 2023);
...
void editer_une_tache()
{
    ...
    if (identifiant_a_editer >= 1 && identifiant_a_editer <= nombre_tache)
    {
        ...
        strcpy(liste_des_taches[identifiant_a_editer ].description, nv_description);
        strcpy(liste_des_taches[identifiant_a_editer ].statut, nv_statut);
        liste_des_taches[identifiant_a_editer ].Date.d = nv_d;
        liste_des_taches[identifiant_a_editer ].Date.m = nv_m;
        liste_des_taches[identifiant_a_editer ].Date.y = nv_y;
